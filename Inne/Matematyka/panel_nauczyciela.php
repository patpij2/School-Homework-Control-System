...
<html lang="en">
<head>
	<? echo '<title>Panel Nauczyciela | Geografia 2.0</title>'; ?>
	<meta charset="UTF-8">
...
<?
$klasy = "1B,1D,1E,1F,1CG,1AG,1BG,1EG,2B,3B";
$klasy_explode = explode(",", $klasy);

for ($x = 0; $x <= 9; $x++) {
	echo '<a href=edytor.php?klasa_system='.$klasy_explode[$x].'><div class="container-contact100-form-btn" style="float: left; padding: 10px;">
